#Based on https://github.com/akarshzingade/image-similarity-deep-ranking/
#Adjustments had to be made so that ImageDataGeneratorCustom could properly process train_triplets.txt
...
def _list_valid_filenames_in_directory(directory, white_list_formats,
    ...
    def _recursive_list(subpath):
        ...
        for triplet in triplets:
            ...
            if len(triplet)!=3:
                continue
            filenames +=['./food/'+triplet[0]+'.jpg']
            filenames +=['./food/'+triplet[1]+'.jpg']
            filenames +=['./food/'+triplet[2]+'.jpg']
